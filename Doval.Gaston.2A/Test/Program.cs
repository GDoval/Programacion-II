...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            pd1.ExtenderPlazo(new DateTime(2025, 12, 01));
            pp1.ExtenderPlazo(new DateTime(2025, 02, 01));
